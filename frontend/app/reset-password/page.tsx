  ...
  if (!token) {
    return (
      <div style={{
        ...
        <div style={{
          width: "100%", maxWidth: "400px", background: "#132236",
          border: "1px solid #1E3A5F", borderRadius: "16px", padding: "32px",
          ...
          <p style={{ color: "#5A7A95", fontSize: "13px", margin: "0 0 24px" }}>
      ...
      <div style={{
        ...
        {success ? (
          <div style={{ textAlign: "center" }}>
            ...
            <p style={{ color: "#5A7A95", fontSize: "13px", lineHeight: 1.6, margin: "0 0 24px" }}>
          ...
          <>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ marginBottom: "16px" }}>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <button type="button" onClick={() => setShowPassword(!showPassword)}
                    style={{ position: "absolute", right: "12px", top: "50%", transform: "translateY(-50%)", background: "none", border: "none", color: "#5A7A95", cursor: "pointer", display: "flex", alignItems: "center", padding: "4px" }}>
                    {showPassword ? <EyeOff size={16} /> : <Eye size={16} />}
                  </button>
                </div>
                {password && (
                  <p style={{ color: passwordLongEnough ? "#4ADE80" : "#F87171", fontSize: "11px", marginTop: "4px" }}>
                    {passwordLongEnough ? "✓ Good length" : "✗ At least 8 characters required"}
                  </p>
                )}
              </div>
              ...
              <div style={{ marginBottom: "24px" }}>
                ...
                {confirm && (
                  <p style={{ color: passwordsMatch ? "#4ADE80" : "#F87171", fontSize: "11px", marginTop: "4px" }}>
              ...
              <button
                ...
                style={{
                  ...
                  background: loading ? "#1A5276" : (passwordsMatch && passwordLongEnough) ? "#2E86C1" : "#1A3A5C",
                  color: "white", fontWeight: 600, fontSize: "14px",
                  border: "none", cursor: (loading || !passwordsMatch || !passwordLongEnough) ? "not-allowed" : "pointer",
            ...
            <div style={{ borderTop: "1px solid #1E3A5F", marginTop: "24px", paddingTop: "20px", textAlign: "center" }}>
              <p style={{ color: "#5A7A95", fontSize: "13px", margin: 0 }}>
                Link expired?{" "}
                <Link href="/forgot-password" style={{ color: "#2E86C1", fontWeight: 600, textDecoration: "none" }}>
                  Request a new one
                </Link>
              </p>
            </div>
