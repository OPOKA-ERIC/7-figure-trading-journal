      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: "20px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "7px" }}>
              <label style={{ color: "#7A9BB5", fontSize: "11px", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.07em" }}>
                Password
              </label>
              <Link href="/forgot-password" style={{ color: "#2E86C1", fontSize: "12px", textDecoration: "none" }}>
                Forgot password?
              </Link>
            </div>
        ...
        <div style={{ borderTop: "1px solid #1E3A5F", marginTop: "24px", paddingTop: "20px", textAlign: "center" }}>
          <p style={{ color: "#5A7A95", fontSize: "13px", margin: 0 }}>
            ...
            <Link href="/register" style={{ color: "#2E86C1", fontWeight: 600, textDecoration: "none" }}>
              Create one free
            </Link>
          </p>
        </div>
